...
public class ProfileListAdapter extends ArrayAdapter<String> {
    ...
    public ProfileListAdapter(Activity context, String[] maintitle, String[] subtitle, Integer[] imgid) {
        super(context, R.layout.profilelist, maintitle);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        ImageView imageView = rowView.findViewById(R.id.poza_preparat);
